  ...
  <div class="fluid-container">
    <div class="post-header">
      <div class="post-header-text">
        ...
        <h1 class="post-title">Cheese Bored: My Weeklong Experimental Affair with Cheese Board Pizza</h1>
        <div class="post-metadata post-byline">
          <span class="byline-prefix">By</span>
          <span class="byline-name"><a href="//wikichen.is">Jonathan E. Chen</a></span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="post-content">
      ...
      <div class="row-fluid">
        ...
        <div class="span5">
          <img class="vertical-image" src="assets/coke.jpg" alt="Mexican Coke" />
